...
from params import function_param_grid_kernel_ridge_classification
...
file_model_name = 'Kernel_ridge_classification'
...
{'-'*20}
'Model: {model} 
\tDataset: {args.dataset}  of shape {X_train.shape} \tCV: {args.cv} \tn_jobs: {args.n_jobs}
\t params: { param_grid}
{'-'*20}
'''
print(head_title)
